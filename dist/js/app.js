...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuExample = React.createClass({ displayName: "MenuExample",
	    ...
	    render: function render() {
	        ...
	        return React.createElement("div", null, React.createElement("ul", { className: "top-nav" }, this.props.items.map(function (m, index) {
	        ...
	        })), React.createElement("p", { className: "menu-output" }, "Selected: ", this.props.items[this.state.focused]));
	    }
	});

	// Render the menu component on the page, and pass an array with menu options

	ReactDOM.render(React.createElement(MenuExample, { items: ['Home', 'Services', 'About', 'Contact us'] }), document.body);
